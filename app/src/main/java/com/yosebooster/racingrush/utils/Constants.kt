...
object Constants {
    ...
    // power-ups
    const val POWER_UP_DURATION_MS = 10000L
    const val TURBO_SPEED_BOOST = 10

    // missions/achievements
    const val MISSION_SCORE_TARGET = 1000
    const val MISSION_COINS_TARGET = 50
    const val ACHIEVEMENT_HIGH_SCORE_TARGET = 5000
}